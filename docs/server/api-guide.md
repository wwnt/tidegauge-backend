...
Purpose: explain the minimum login and data query workflow against the `tide_server` HTTP API.

Audience: API consumers, integrators, and operators validating historical data access.

Related Docs: [tide_server guide](../../tide_server/README.md), [Documentation index](../README.md)
