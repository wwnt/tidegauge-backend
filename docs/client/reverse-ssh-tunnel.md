...
Purpose: document how to keep an outbound reverse SSH tunnel alive with `systemd` for field access.

Audience: operators maintaining `tide_client` nodes behind private networks.
