# SDI-12 Noise Mitigation

Purpose: capture practical field guidance for reducing SDI-12 bus noise.

Audience: hardware integrators and operators troubleshooting unstable SDI-12 sensors.

Related Docs: [tide_client guide](../../tide_client/README.md), [Client config reference](config-reference.md)
